  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ p: 3 }}>
        <Toolbar />
        <div className='pt6 none'>
          <div className='container'>
            <div className='row'>
              <div className='col1'>
                <Typography variant='p' className='fs-12'> WELCOME TO SCROLLTECHSOFI</Typography>
                <Typography variant="h1" className='fss'>
                  The first
                  <br></br>
                  <Typography variant='span' className='fss1'>SocialFi on Scroll</Typography>
                </Typography>
